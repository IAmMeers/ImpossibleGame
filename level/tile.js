class Tile {
    ...
    updateBB() {
        this.lastBB = this.BB;
        this.BB = new BoundingBox(this.x + this.bbX, this.y + this.bbY, this.bbWidth, this.bbHeight);
                ...
                if (element["id"] === this.localID) { //Search tiles array for matching tile ID
                    ...
                    for (let j = 0; j < objects.length; j++) {
                        ...
                        if (object["class"] === 'BB') { //Check if tile has bounding box data
                            ...
                            this.bbWidth = object["width"] * PARAMS.SCALE;
                            this.bbHeight = object["height"] * PARAMS.SCALE;
                            this.bbX = object["x"] * PARAMS.SCALE;
                            this.bbY = object["y"] * PARAMS.SCALE;
                        }
                    }
                    //});
